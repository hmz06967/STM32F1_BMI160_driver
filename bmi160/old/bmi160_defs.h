...
typedef HAL_StatusTypeDef (*bmi160_read_fptr_t)(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout);

//typedef int8_t (*bmi160_write_fptr_t)(uint8_t dev_addr, uint8_t reg_addr, uint8_t *read_data, uint16_t len);
typedef HAL_StatusTypeDef (*bmi160_write_fptr_t)(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size, uint32_t Timeout);

typedef HAL_StatusTypeDef (*bmi160_uart_fptr_t)(UART_HandleTypeDef *huart, uint8_t *pData, uint16_t Size, uint32_t Timeout);	
